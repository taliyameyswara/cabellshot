...
@section('content')
    <div class="content">
        <h2 class="content-heading">Read Contact Queries</h2>

        <!-- Dynamic Table Full Pagination -->
        <div class="block">
            <div class="block-header block-header-default">
                <h3 class="block-title">Read Contact Queries</h3>
            </div>
            <div class="block-content block-content-full">
                <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                    ...
                    <tbody>
                        ...
                        @else
                            <tr>
                                <td colspan="5" class="text-center">No read contact queries found.</td>
                            </tr>
                        @endif
                    </tbody>
                </table>
